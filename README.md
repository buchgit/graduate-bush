...
<br>
###### <a name="note"> NOTE: file with full collection of check endpoint commands: "graduate_bush.postman_collection.json" is located in the root directory of the project</a>
